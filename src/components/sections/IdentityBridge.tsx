  ...
  return (
    <section ref={sectionRef} style={{ height: "300vh", position: "relative", backgroundColor: "#FCEBE5" }} aria-label="Identity Bridge">
      <div style={{ position: "sticky", top: 0, height: "100vh", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <div style={{ position: "absolute", zIndex: 1, textAlign: "center", padding: "0 20px" }}>
          <h2 style={{ fontFamily: "var(--font-anton), Anton, sans-serif", fontSize: "11vw", textTransform: "uppercase", color: "#111", lineHeight: 0.9, margin: 0, letterSpacing: "0.02em" }}>
            CULTURE<br />IN MOTION
          </h2>
          <p style={{ fontFamily: "var(--font-bricolage), 'Bricolage Grotesque', sans-serif", fontSize: "1.1rem", color: "#7A6C60", marginTop: "32px", maxWidth: "600px", marginInline: "auto", lineHeight: 1.6 }}>
